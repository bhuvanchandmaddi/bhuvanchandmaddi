...
- 🔭 I’m currently working on [EKS Cluster Creation using Terraform & karpenter for cluster autoscaling](https://github.com/bhuvanchandmaddi/Terraform-eks-karpenter) and [CI/CD setup on single host using docker-compose](https://github.com/bhuvanchandmaddi/local-CI-CD-with-docker-compose)
